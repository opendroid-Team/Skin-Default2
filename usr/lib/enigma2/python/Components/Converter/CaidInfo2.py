                                        ...
                                        if ecm_info:
                                                ...
                                                if self.type == self.ALL:
                                                        if source == "emu":
                                                                ...
                                                                textvalue = "%s - Prov: %s, Caid: %s, Reader: %s, %s (%s) Ecm: %ss - Hop: %s" % (source, prov, caid, reader, protocol, server, ecm_time, hops)
                                                        elif reader != "" and source != "net": 
                                                                textvalue = "%s - Prov: %s, Caid: %s, Reader: %s, %s (local) Ecm: %ss - Hop: %s" % (source, prov, caid, reader, protocol, ecm_time, hops)
